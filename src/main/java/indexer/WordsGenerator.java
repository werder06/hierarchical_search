...
public class WordsGenerator {
    private static String _commonWords = "../join-tester/WordsMostCommon.txt";
    private static String _englishWords = "../join-tester/WordsEnglish.txt";

    private static List<String> _commonList = new ArrayList<String>(3001);
    ...
    public static String getEnglishWord() {
        return _englishList.get(_randomGenerator.nextInt(_englishList.size()));
    }
    ...
    public static void fillList(File file, List<String> list) throws Exception {
        ...
        while ((strLine = br.readLine()) != null) {
            ...
            for (String part : parts) {
                list.add(part.replaceAll("\\W", "").trim());
            }
        }
    ...
    public static String genLatLon() {
        ...
        return String.format("%d.%d,%d.%d",
                WordsGenerator.getInt(89) * ((latNeg) ? -1 : 1),
                WordsGenerator.getInt(10000),
                WordsGenerator.getInt(89) * ((lonNeg) ? -1 : 1),
                WordsGenerator.getInt(10000));
